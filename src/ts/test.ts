...
function styleTest(Queue: CommandQueue) {
  ...
  Queue.add({ func: DocsInteractions.pasteText, params: { text: '\n\nStyle Test\n\n' } })
  Queue.add({ func: DocsInteractions.toggleBold, params: [], delay: 5 })
  Queue.add({ func: DocsInteractions.pasteText, params: { text: "This text shouldn't be bold\n\n" }, delay: 5 })
  Queue.add({ func: DocsInteractions.toggleBold, params: [], delay: 5 })
  Queue.add({ func: DocsInteractions.pasteText, params: { text: 'This text should be bold\n\n' }, delay: 5 })
  Queue.add({ func: DocsInteractions.toggleBold, params: [] })
  Queue.add({ func: DocsInteractions.pasteText, params: { text: "This text shouldn't be bold\n\n" } })

  Queue.add({ func: DocsInteractions.toggleItalic, params: [] })
  Queue.add({ func: DocsInteractions.pasteText, params: { text: 'This text should be italic\n\n' } })
  Queue.add({ func: DocsInteractions.toggleItalic, params: [] })
  Queue.add({ func: DocsInteractions.pasteText, params: { text: "This text shouldn't be italic\n\n" } })

  Queue.add({ func: DocsInteractions.toggleUnderline, params: [] })
  Queue.add({ func: DocsInteractions.pasteText, params: { text: 'This text should be underlined\n\n' } })
  Queue.add({ func: DocsInteractions.toggleUnderline, params: [] })
  Queue.add({ func: DocsInteractions.pasteText, params: { text: "This text shouldn't be underlined\n\n" } })
}
...
function colorTest(Queue: CommandQueue) {
  ...
  Queue.add({ func: DocsInteractions.pasteText, params: { text: 'This text should be red\n\n' } })
  Queue.add({ func: DocsInteractions.pickColor, params: { color: 'green' } })
  Queue.add({ func: DocsInteractions.pasteText, params: { text: 'This text should be green\n\n' } })
  Queue.add({ func: DocsInteractions.pickColor, params: { color: 'purple' } })
  Queue.add({ func: DocsInteractions.pasteText, params: { text: 'This text should be purple\n\n' } })
  Queue.add({ func: DocsInteractions.pickColor, params: { color: 'black' } })
  Queue.add({ func: DocsInteractions.pasteText, params: { text: 'Back to black\n\n' } })
}
...
function homeEndTest(Queue: CommandQueue) {
  ...
  Queue.add({ func: DocsInteractions.pasteText, params: { text: 'abcdefghijklmnopqrstuvwxyz' } })
  Queue.add({ func: DocsInteractions.pressKey, params: { key: 'Home' } })
